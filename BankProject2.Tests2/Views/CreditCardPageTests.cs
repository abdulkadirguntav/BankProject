...
{
    public class CreditCardPageTests
    {
        private DbContextOptions<BankDbContext> _options;

        public CreditCardPageTests()
        {
        ...
        public void Constructor_ShouldInitializeWithCustomerId()
        {
            ...
            // var creditCardPage = new CreditCardPage(1); // Bu satırı kaldırıyoruz
        ...
        [Fact]
        public void LoadCreditCardData_ShouldCalculateAvailableCreditCorrectly()
        {
            // Arrange
            using (var context = new BankDbContext(_options))
            {
            ...
            using (var context = new BankDbContext(_options))
            {
                ...
                Assert.Equal(4000f, availableCredit); // 5000 - 1000 = 4000
            }
        }
        ...
        [Fact]
        public void LoadCreditCardData_ShouldHandleZeroBalance()
        {
            // Arrange
            using (var context = new BankDbContext(_options))
            {
            ...
            using (var context = new BankDbContext(_options))
            {
                ...
                Assert.Equal(5000f, availableCredit); // Tüm limit kullanılabilir
            }
        }
        ...
        public void LoadCreditCardData_ShouldHandleMultipleCreditCards()
        {
            ...
            using (var context = new BankDbContext(_options))
            {
                ...
                var totalDebt = creditCards.Sum(c => c.CurrentDebt);

                // Assert
                Assert.Equal(3, creditCards.Count);
                Assert.Equal(17000f, totalLimit); // 5000 + 10000 + 2000
                Assert.Equal(4500f, totalDebt); // 1000 + 3000 + 500
            }
        }
    }
}
